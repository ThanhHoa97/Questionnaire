...
function submitForm(e){
    ...
    console.log(q1, q2, currentScenario, currentVideoOrder);

    saveMessages(q1, q2, currentScenario, currentVideoOrder);
...
const saveMessages = (q1, q2, currentScenario, currentVideoOrder) => {
